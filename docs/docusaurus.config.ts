...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://github.com/hashgraph/hedera-wallet-connect/discussions',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Hedera. Built with Docusaurus.`,
    },
    prism: {
